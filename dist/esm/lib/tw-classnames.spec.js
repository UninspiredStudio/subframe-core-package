...
describe("twClassNames", () => {
    ...
    describe("font mixins", () => {
        it("should override font sizes", () => {
            expect(twClassNames("text-label", "text-[24px] font-[500] leading-[38px]")).toBe("text-[24px] font-[500] leading-[38px]");
            expect(twClassNames("text-[24px] font-medium leading-[38px]", "text-label")).toBe("text-label");
            expect(twClassNames("text-[24px] font-[500] leading-[38px]", "text-[14px] font-[400] leading-[16px]")).toBe("text-[14px] font-[400] leading-[16px]");
        });
    });
