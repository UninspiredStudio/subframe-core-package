...
const Root = React.forwardRef(function Root2({ className, type = "single", ...otherProps }, ref) {
  return /* @__PURE__ */ React.createElement(RadixToggleGroup__namespace.Root, { ref, className, type, ...otherProps });
});
